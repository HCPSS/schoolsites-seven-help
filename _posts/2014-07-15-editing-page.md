...
If you are having trouble finding a piece of content, such as a page section, view the documentation for [finding page sections](/schoolsites-seven-help/edit/2014/07/15/finding-content/).

## Basic Editing

You can add content via the text editor in the same way that you type up a word document or HCPSS News Message.

![add content](/schoolsites-seven-help/images/pages/page-wysiwyg.png)
...
![page editor](/schoolsites-seven-help/images/pages/bold-text.png)
...
![make plaintext](/schoolsites-seven-help/images/additional-formatting.png)
...
- **Adding links** involves grabbing URLs a certain way. [Learn more about links.](/schoolsites-seven-help/edit/2014/07/15/adding-links/)
- **Adding images** is [a separate topic](/schoolsites-seven-help/images/2014/07/15/adding-images/) that can be done only in a few places on your site.
- **Adding documents** is also a [different topic](/schoolsites-seven-help/files/2016/12/13/uploading-files/) that involves the dashboard's "add file" feature.
...
![adding headings](/schoolsites-seven-help/images/pages/headings.png)
