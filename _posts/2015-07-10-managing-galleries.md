...
Gallery highlights on the homepage are the end-product after creating a gallery. Read more on how to [manage gallery highlights](/schoolsites-seven-help/hs-homepage/2015/07/15/gallery-highlights/).

To begin editing a gallery go to add content, and then gallery.

![add content](/schoolsites-seven-help/images/hs-files/add-content.png)

![add gallery content type](/schoolsites-seven-help/images/hs-files/add-gallery-type.png)
...
![title and description](/schoolsites-seven-help/images/hs-files/description-title.png)
...
![using taxonomy](/schoolsites-seven-help/images/hs-files/gallery-taxonomy.png)
...
![gallery key image](/schoolsites-seven-help/images/hs-files/key-image.png)

Remember, you can always select an image that's already on your site by using the "library" tab after clicking on "browse".

![library tab](/schoolsites-seven-help/images/hs-files/choose-library-tab.png)
...
![attach new media](/schoolsites-seven-help/images/hs-files/attach-media.png)

![upload new file](/schoolsites-seven-help/images/hs-files/upload-new-file.png)

Alternatively, you can also add images using the "library" option or oembed. [Learn more about what oembed is](/schoolsites-seven-help/hs-gallery-mgmt/2015/07/10/using-oembed/) and how it can incorporate with your galleries.
...
![alternative text editing](/schoolsites-seven-help/images/hs-files/alt-text-file-name.png)
...
![save](/schoolsites-seven-help/images/hs-files/save-button.png)

Once you've added the images you can re-arrange their order to your liking using the directional compass.

![re-arranging images](/schoolsites-seven-help/images/hs-files/image-information.png)
...
![find content](/schoolsites-seven-help/images/hs-files/add-content.png)
...
![filter and find content](/schoolsites-seven-help/images/hs-files/type-filter-find.png)

The listing gives you the option to edit or delete any piece of content.

![edit or delete](/schoolsites-seven-help/images/hs-files/edit-delete.png)
...
![reset](/schoolsites-seven-help/images/hs-files/reset.png)
