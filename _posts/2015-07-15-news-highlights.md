...
![dashboard](/schoolsites-seven-help/images/hs-files/dashboard.png)

![arrange and manage lists](/schoolsites-seven-help/images/news/manage-lists.png)
...
![add new highlight](/schoolsites-seven-help/images/hs-files/add-new-highlight.png)
...
![existing highlight](/schoolsites-seven-help/images/hs-files/existing-highlight.png)

From here, you can re-arrange your news item's position by using the directional rose to the left of its title.

![existing highlight](/schoolsites-seven-help/images/hs-files/after-adding.png)
...
![existing highlight](/schoolsites-seven-help/images/hs-files/edit-remove-hp.png)
...
![existing highlight](/schoolsites-seven-help/images/hs-files/remove-item.png)
