...
![add content](/schoolsites-seven-help/images/resources/add-content.png)

From there, click on "link resource group" which will bring you to an editing page with empty fields.

![add link group](/schoolsites-seven-help/images/resources/link-group-add.png)

These empty fields can be populated with the title of your group, such as "Business Partners" or "College Preparedness".

![add link group](/schoolsites-seven-help/images/resources/link-group-add-field.png)
...
Then, [start adding link resource items to the list](/schoolsites-seven-help/resources/2016/12/14/link-resources-item/), which is unlimited but an ideal amount is more than 3 and less than 15.
