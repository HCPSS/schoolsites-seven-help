...
This topic explores how to upload a PDF file and link to it on your site. [Replacing files](/schoolsites-seven-help/files/2014/07/15/replacing-files/) is a separate topic, along with [adding links to external sites](/schoolsites-seven-help/edit/2014/07/15/adding-links/).
...
![dashboard](/schoolsites-seven-help/images/dashboard.png)

Under file management on the right-hand side, select "add & manage files."

![add and manage files](/schoolsites-seven-help/images/uploading/add-manage-files.png)

Here is where you'll find all of the files that have been uploaded to the site. To add a new file, select "add file."

![add file](/schoolsites-seven-help/images/uploading/add-file-button.png)
...
![choose file](/schoolsites-seven-help/images/uploading/choose-file.png)

Selecting "next" will bring you to a page where the file "lives." Avoid linking to this page because it's for admins only.

![placeholder page](/schoolsites-seven-help/images/uploading/placeholder-page.png)

Click on the file name under the "view, edit, etc." menu.

![upload confirmation](/schoolsites-seven-help/images/uploading/get-file-link.png)
...
![proper URL](/schoolsites-seven-help/images/uploading/pdf-url.png)

Copy this URL address.

Ready to link it on your site? <a href="/schoolsites-seven-help/edit/2014/07/15/adding-links/">Learn how &rarr;</a>
