...
Clicking on the "school resources" tab in the navigation is the easiest way to edit items. Remember, if you're really lost on where a link resource group is, use the [find content](/schoolsites-seven-help/edit/2014/07/15/finding-content/) feature.

![add content](/schoolsites-seven-help/images/resources/school-resources-nav.png)
...
![hover list](/schoolsites-seven-help/images/resources/hover-list.png)
...
![hover list](/schoolsites-seven-help/images/resources/edit-whole-list.png)

From there, you can click on "add new link resource".

![](/schoolsites-seven-help/images/resources/add-link-resource-item.png)
...
- If you're unfamiliar **with how to get links to PDFs** that you've uploaded, feel free to [review that help topic](/schoolsites-seven-help/files/2016/12/13/uploading-files/).

- Take a look at **how to get link to external webpages** such as MackinVia and other sites [if you're unfamilar](/schoolsites-seven-help/edit/2014/07/15/adding-links/).
...
![add pdf to item](/schoolsites-seven-help/images/resources/editing-link-information.png)
